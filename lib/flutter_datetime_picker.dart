...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? ADatePickerTheme(),
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    ADatePickerTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(ADatePickerTheme theme) {
  ...
  Widget _renderItemView(ADatePickerTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(ADatePickerTheme theme) {
